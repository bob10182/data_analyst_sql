...
--nswer: American Express and General Motors are tied at 4.199999809

--11.	Find all the job titles that contain the word ‘Analyst’. How many different job titles are there? 
SELECT COUNT(title)
FROM data_analyst_jobs
WHERE LOWER (title) LIKE LOWER ('%analyst%');
--Answer:1669, assuming you wanted a total count not DISTINCT
...
--Answer: 4, Tableau is the keyword
...
--Answer: Part 1: Consulting and Business Services, Computers and Electronics and Real Estate.
--Answer: Part 2: Consutling and Business Services=5, Computers and Electronics=1, Real Estate=1, Consumer Goods and Services=2


--BONUS BONUS--
--1. For each company, give the company name and the difference between its star rating and the national average star rating. 
SELECT (star_rating)-(AVG(star_rating)) AS diff_star_rating,company
FROM data_analyst_jobs
GROUP BY data_analyst_jobs.star_rating,data_analyst_jobs.company;
